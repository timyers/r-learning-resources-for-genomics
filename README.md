...
- [A Succinct Intro to R](http://r-guide.steveharoz.com/) - This online book by Steve Haroz, is a short introduction to the `R` language. 
...
- [Seurat](https://satijalab.org/seurat/index.html) - `R` toolkit for singel cell genomics.
