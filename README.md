...
[![star this repo](https://githubbadges.com/star.svg?user=timyers&repo=r-learning-resources-for-genomics&style=flat-square)](https://github.com/timyers/r-learning-resources-for-genomics)
[![fork this repo](https://githubbadges.com/fork.svg?user=timyers&repo=r-learning-resources-for-genomics&style=flat-square)](https://github.com/timyers/r-learning-resources-for-genomics/fork)
...
- [bigsnpr](https://privefl.github.io/bigsnpr/index.html) - An `R` package for the analysis of massive SNP arrays, primarily designed for human genetics.  It enhances the features of package [bigstatsr](https://privefl.github.io/bigstatsr/) for the purpose of analyzing genotype data.  [Here]is a (https://privefl.github.io/bigsnpr/articles/demo.html) short demonstration of `bigsnpr` and `bigstatsr`. 
