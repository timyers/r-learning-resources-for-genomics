...
- [How to Get Started with R: A Video](https://www.youtube.com/watch?v=wfshEa_F2FQ) - In this brief YouTube video, you will find all the essentials you need to get started with `R` Programming Language.  Make sure to download `R` and RStudio to your local machine first.  Brought to you by the Duke Center for Computational Thinking.
