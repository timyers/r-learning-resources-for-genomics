...
### Anti-R
- [jamovi](https://www.jamovi.org/) - A free and open source point-and-click statistical program.  jamovi is built on top of the `R` statistical language making it easy to access the code for your analysis. 
