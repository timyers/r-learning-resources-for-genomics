...
- [Data Visualization - A practical introduction](https://socviz.co/index.html#preface) - A treasure trove of R-dataviz help by Kieran Healy.
...
- [bigsnpr](https://privefl.github.io/bigsnpr/index.html) - An `R` package for the analysis of massive SNP arrays, primarily designed for human genetics.  It enhances the features of package [bigstatsr](https://privefl.github.io/bigstatsr/) for the purpose of analyzing genotype data.  [Here](https://privefl.github.io/bigsnpr/articles/demo.html) is a short demonstration of `bigsnpr` and `bigstatsr`.
- [Computing Polygenic Risk Scores (PRS) using LDpred2](https://privefl.github.io/bigsnpr/articles/LDpred2.html) - A tutorial to show how to compute polygenic risk scores (PRS) using [LDpred2](https://www.biorxiv.org/content/10.1101/2020.04.28.066720v3.full).
...
- [Seurat](https://satijalab.org/seurat/index.html) - `R` toolkit for single cell genomics.
...
- [targets pipeline tool for R](https://docs.ropensci.org/targets/) - The `targets` package is a [Make](https://www.gnu.org/software/make/)-like pipeline tool for statistics and data science in `R`. With `targets`, you can maintain a reproducible workflow without repeating yourself. 
