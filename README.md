...
- [Generating Dockerfiles for Reproducible Research with R](https://o2r.info/containerit/articles/containerit.html) - The `R` package `containerit` aims to make reproducible and archivable research with containers easy. 
