...
- [Computing polygenic scores using LDpred2](https://privefl.github.io/bigsnpr/articles/LDpred2.html) - A tutorial for to show how to compute polygenic risk scores (PRS) using [LDpred2](https://www.biorxiv.org/content/10.1101/2020.04.28.066720v3.full).
...
- [The Turing Way](https://the-turing-way.netlify.app/welcome) - An online book to reproducible, ethical and collaborative data science.  [The Turing Way](https://the-turing-way.netlify.app/welcome) also maintains a *Zero-to-Binder* tutorial for 3 common languages, [`Julia`](http://bit.ly/zero-to-binder-julia), [`Python`](http://bit.ly/zero-to-binder-python), and [`R`](http://bit.ly/zero-to-binder-r).  See below for more information about `Binder`.
